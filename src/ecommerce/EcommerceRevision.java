...
public class EcommerceRevision {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("-----------------------------");
        reviewer.valid("ordersOlderThan2026", practices::ordersOlderThan2026, result ->
                result.size() == 20
        );

        System.out.println("-----------------------------");
        reviewer.valid("ordersThatAskedOn2025", practices::ordersThatAskedOn2025, result ->
                result.size() == 12
        );

        System.out.println("-----------------------------");
        reviewer.valid("ordersThatAskedOn2026", practices::ordersThatAskedOn2026, result ->
                result.size() == 10
        );
